import{J,bs as ve,r as W,bt as ct,bu as bt,v as b,bv as ft,bw as q,bx as pt,ad as ut,ae as Se,ba as vt,Q as K,aL as ht,aa as gt,U as xt,ah as mt,by as yt,bz as wt,I as n,an as i,a0 as R,ap as _,aq as Ct,K as Rt,M as Te,bA as he,aN as ee,P as St,Y as te,av as Tt,O as H,bB as zt,at as $t,aF as j,aw as G,R as Pt,a4 as ge,aJ as xe,bC as Wt,V as Y,T as ae,bl as At,aA as _t,bD as Lt,aO as Bt}from"./index-f53dfd2d.js";import{A as Et}from"./Add-8e2e4207.js";const kt=ve(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[ve("&::-webkit-scrollbar",{width:0,height:0})]),jt=J({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=W(null);function r(l){!(l.currentTarget.offsetWidth<l.currentTarget.scrollWidth)||l.deltaY===0||(l.currentTarget.scrollLeft+=l.deltaY+l.deltaX,l.preventDefault())}const d=ct();return kt.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:bt,ssr:d}),Object.assign({selfRef:e,handleWheel:r},{scrollTo(...l){var h;(h=e.value)===null||h===void 0||h.scrollTo(...l)}})},render(){return b("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var It=/\s/;function Ot(e){for(var r=e.length;r--&&It.test(e.charAt(r)););return r}var Ft=/^\s+/;function Ht(e){return e&&e.slice(0,Ot(e)+1).replace(Ft,"")}var me=0/0,Mt=/^[-+]0x[0-9a-f]+$/i,Dt=/^0b[01]+$/i,Nt=/^0o[0-7]+$/i,Vt=parseInt;function ye(e){if(typeof e=="number")return e;if(ft(e))return me;if(q(e)){var r=typeof e.valueOf=="function"?e.valueOf():e;e=q(r)?r+"":r}if(typeof e!="string")return e===0?e:+e;e=Ht(e);var d=Dt.test(e);return d||Nt.test(e)?Vt(e.slice(2),d?2:8):Mt.test(e)?me:+e}var Ut=function(){return pt.Date.now()};const re=Ut;var Xt="Expected a function",Gt=Math.max,Yt=Math.min;function Kt(e,r,d){var u,l,h,v,f,g,x=0,y=!1,w=!1,m=!0;if(typeof e!="function")throw new TypeError(Xt);r=ye(r)||0,q(d)&&(y=!!d.leading,w="maxWait"in d,h=w?Gt(ye(d.maxWait)||0,r):h,m="trailing"in d?!!d.trailing:m);function C(c){var z=u,I=l;return u=l=void 0,x=c,v=e.apply(I,z),v}function S(c){return x=c,f=setTimeout(L,r),y?C(c):v}function A(c){var z=c-g,I=c-x,F=r-z;return w?Yt(F,h-I):F}function $(c){var z=c-g,I=c-x;return g===void 0||z>=r||z<0||w&&I>=h}function L(){var c=re();if($(c))return T(c);f=setTimeout(L,A(c))}function T(c){return f=void 0,m&&u?C(c):(u=l=void 0,v)}function B(){f!==void 0&&clearTimeout(f),x=0,u=g=l=f=void 0}function k(){return f===void 0?v:T(re())}function p(){var c=re(),z=$(c);if(u=arguments,l=this,g=c,z){if(f===void 0)return S(g);if(w)return clearTimeout(f),f=setTimeout(L,r),C(g)}return f===void 0&&(f=setTimeout(L,r)),v}return p.cancel=B,p.flush=k,p}var qt="Expected a function";function ne(e,r,d){var u=!0,l=!0;if(typeof e!="function")throw new TypeError(qt);return q(d)&&(u="leading"in d?!!d.leading:u,l="trailing"in d?!!d.trailing:l),Kt(e,r,{leading:u,maxWait:r,trailing:l})}const se=ut("n-tabs"),ze={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},aa=J({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:ze,setup(e){const r=Se(se,null);return r||vt("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:r.paneStyleRef,class:r.paneClassRef,mergedClsPrefix:r.mergedClsPrefixRef}},render(){return b("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),Jt=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},wt(ze,["displayDirective"])),ie=J({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:Jt,setup(e){const{mergedClsPrefixRef:r,valueRef:d,typeRef:u,closableRef:l,tabStyleRef:h,tabChangeIdRef:v,onBeforeLeaveRef:f,triggerRef:g,handleAdd:x,activateTab:y,handleClose:w}=Se(se);return{trigger:g,mergedClosable:K(()=>{if(e.internalAddable)return!1;const{closable:m}=e;return m===void 0?l.value:m}),style:h,clsPrefix:r,value:d,type:u,handleClose(m){m.stopPropagation(),!e.disabled&&w(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){x();return}const{name:m}=e,C=++v.id;if(m!==d.value){const{value:S}=f;S?Promise.resolve(S(e.name,d.value)).then(A=>{A&&v.id===C&&y(m)}):y(m)}}}},render(){const{internalAddable:e,clsPrefix:r,name:d,disabled:u,label:l,tab:h,value:v,mergedClosable:f,style:g,trigger:x,$slots:{default:y}}=this,w=l!=null?l:h;return b("div",{class:`${r}-tabs-tab-wrapper`},this.internalLeftPadded?b("div",{class:`${r}-tabs-tab-pad`}):null,b("div",Object.assign({key:d,"data-name":d,"data-disabled":u?!0:void 0},ht({class:[`${r}-tabs-tab`,v===d&&`${r}-tabs-tab--active`,u&&`${r}-tabs-tab--disabled`,f&&`${r}-tabs-tab--closable`,e&&`${r}-tabs-tab--addable`],onClick:x==="click"?this.activateTab:void 0,onMouseenter:x==="hover"?this.activateTab:void 0,style:e?void 0:g},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),b("span",{class:`${r}-tabs-tab__label`},e?b(gt,null,b("div",{class:`${r}-tabs-tab__height-placeholder`}," "),b(xt,{clsPrefix:r},{default:()=>b(Et,null)})):y?y():typeof w=="object"?w:mt(w!=null?w:d)),f&&this.type==="card"?b(yt,{clsPrefix:r,class:`${r}-tabs-tab__close`,onClick:this.handleClose,disabled:u}):null))}}),Qt=n("tabs",`
