...
func (*Article) GetFrontList(c *gin.Context) {
	r.SuccessData(c, articleService.GetFrontList(utils.BindQuery[req.GetFrontArts](c), c))
}
...
func (*Article) GetArchiveList(c *gin.Context) {
	r.SuccessData(c, articleService.GetArchiveList(utils.BindQuery[req.GetFrontArts](c), c))
}
...
func (*Article) SaveLike(c *gin.Context) {
	...
	r.SendCode(c, articleService.SaveLike(uid, articleId, c))
}

// 文章搜索
func (*Article) Search(c *gin.Context) {
	r.SuccessData(c, articleService.Search(utils.BindQuery[req.KeywordQuery](c), c))
}
